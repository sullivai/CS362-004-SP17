...
int sSmithy(struct gameState *state, int currentPlayer, int handPos)
{
	int i;
	for (i = 1; i < 3; i++)
	{
...
int aAdventurer(struct gameState *state, int currentPlayer)
{
	int z = 0; 
	int cardDrawn;
	int drawntreasure = 0;
...
int cCutpurse(struct gameState *state, int currentPlayer, int handPos)
{
	int i;
	int j;
	int k;
...
int vVillage (struct gameState *state, int currentPlayer, int handPos)
{
	drawCard(currentPlayer, state);
...
int cCouncilRoom (struct gameState *state, int currentPlayer, int handPos)
{
      int i;  
      for (i = 0; i < 4; i++)
      {
