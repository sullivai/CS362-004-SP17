...
int main() {
    ...
    for (deckCount = 0; deckCount < maxHandCount; deckCount++){
        ...
        sprintf(msg,"CURSE with %d in hand, %d in discard, %d in deck. Score: %d Expected: %d\n", handCount, discardCount, deckCount, scoreFor(p,&G), (-1 * totalCards));
        ...
        sprintf(msg,"ESTATE with %d in hand, %d in discard, %d in deck. Score: %d Expected: %d\n", handCount, discardCount, deckCount, scoreFor(p,&G), (1 * totalCards));
        ASSERT2(scoreFor(p,&G) == (1 * totalCards),msg);
        ...
        sprintf(msg,"DUCHY with %d in hand, %d in discard, %d in deck. Score: %d Expected: %d\n", handCount, discardCount, deckCount, scoreFor(p,&G), (3 * totalCards));
        ...
        sprintf(msg,"PROVINCE with %d in hand, %d in discard, %d in deck. Score: %d Expected: %d\n", handCount, discardCount, deckCount, scoreFor(p,&G), (6 * totalCards));
        ...
        sprintf(msg,"GREAT_HALL with %d in hand, %d in discard, %d in deck. Score: %d Expected: %d\n", handCount, discardCount, deckCount, scoreFor(p,&G), (1 * totalCards));
        ...
        sprintf(msg,"GARDEN with %d in hand, %d in discard, %d in deck. Score: %d Expected: %d\n", handCount, discardCount, deckCount, scoreFor(p,&G), (totalCards/10));
