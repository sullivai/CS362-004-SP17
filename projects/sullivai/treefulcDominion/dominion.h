...
int playAdventurer(int curPlayer, struct gameState *state);
int playSmithy(int curPlayer, struct gameState *state, int handPos);
int playVillage(int curPlayer, struct gameState *state, int handPos);
